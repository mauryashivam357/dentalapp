...
public class DentalImplant extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dental_implant);
        ...
        if (actionBar != null) {
            ...
            SpannableString title = new SpannableString("Dental Implant");
