...
public class SingleToothimplant extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_toothimplant);
        ...
        if (actionBar != null) {
            ...
            SpannableString title = new SpannableString("Single Tooth Implant");
